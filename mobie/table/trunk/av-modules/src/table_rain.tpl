...
<!--风情表格数据-->
 <div class="col-xs-12 pa1">
    <table class="table table-bordered" ms-each="rainData"> 
       <col ms-repeat="rainhead" ms-css-width="el"/>
       <tr>
         <td class="cen">{{el.addvcd}}</td>
         <td class="cen">{{el.stnm}}</td>
         <td class="cen">{{el.rain}}</td>
       </tr>
    </table>
 </div>